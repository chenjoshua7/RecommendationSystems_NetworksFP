...
A similar procedure as done in previous section \textit{User-to-user network} can be done to obtain a movie-to-movie similarity score matrix that will be considered as the adjacency matrix of the movie-to-movie network. Figure \ref{??} and Figure \ref{} describe the network distribution. 

In this section, community detection would be performed in order to identify communities among the movies. 
