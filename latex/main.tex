...
In order to evaluate the effectiveness of the recommender system, we perform a train-test split by randomly removing 20\% of each users ratings and subsequently calculate the AUC. The former metric measures the percentage of the top 10 recommendations that have been watched by the user, while the latter reports the percentage of the users top 10 favourite films that were recommended by the algorithm. 
